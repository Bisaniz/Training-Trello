...
import moveTemplatesToListActions from "../../../pageObjects/moveTemplateToList/Actions.cy";
import moveTemplatesToListAssertions from "../../../pageObjects/moveTemplateToList/Assertions.cy";


const sharedDataUtil= new sharedDataUtils
const moveTemplateToListAction = new moveTemplatesToListActions
const moveTemplateToListAssertion = new moveTemplatesToListAssertions
...
When("The user click on the button move",()=>{
    moveTemplateToListAction.clickOnButtonMove()
});

When("Click on the list drop-down",()=>{
    moveTemplateToListAction.clickOnTheListDropDown()
});

When("Choose the list",()=>{
    moveTemplateToListAction.chooseTheList()
});


Then("The template should be moved successfully",()=>{
    moveTemplateToListAssertion.checkNewListIsContain("CypressTemp")
});
